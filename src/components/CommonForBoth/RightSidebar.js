            ...
            <div data-simplebar className="h-100">
              ...
              <div className="p-4">
                    ...
                    <div className="radio-toolbar coloropt-radio">
                      ...
                      <Row>
                        <Col>
                          ...
                          <input
                            type="radio"
                            id="leftsidebarThemessoftblue"
                            name="leftsidebarTheme"
                            value={leftSideBarThemeTypes.SOFTBLUE}
                            checked={
                              this.state.sidebarTheme ===
                              leftSideBarThemeTypes.SOFTBLUE
                            }
                            onChange={this.changeLeftSidebarTheme}
                          />
                          <label
                            htmlFor="leftsidebarThemessoftblue"
                            className="gradient-strong-great-whale rounded-circle wh-30"
                          ></label>
                        </Col>
                      </Row>
                ...
                <Link
                  ...
                  className="btn-custom-theme btn-block mt-3"
                  target="_blank"
                >
