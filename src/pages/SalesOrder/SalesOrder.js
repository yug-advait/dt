...
const SalesOrder = () => {
  ...
  const handleClicks = () => {
    history.push({
      pathname: "/sales_order/create_so",
  ...
  const openModal = (data = null) => {
    ...
    setFormData({
      id: data?.id,
      so_line_item: data?.so_line_item,
      uom: data?.uom?.value,
  ...
  const validateForm = () => {
    ...
    if (!formData.so_line_item) {
      errors.so_line_item = "SO Line Item Number is required.";
    }
    ...
    if (!formData.po_quantity) {
      errors.po_quantity = " SO Quantity is required.";
    }
  ...
  const handleSubmit = async e => {
    ...
    setModal(false);
    const updateLineItemData = await updateLineItemApiCall(formData, "po");
    setToast(true);
  ...
  const columns = useMemo(() => {
    const commonColumns = [
      ...
      //       {/* No checkbox in Product Description for Pending SO tab */}
    ...
    // Add specific columns for Pending SO tab (activeTab === 2)
    // if (activeTab === 1) {
    ...
    if (activeTab !== 1) {
      commonColumns?.unshift(
        ...
        },
        {
          ...
          accessor: "unit_uom",
          // Cell: ({ row }) => {
          //   return <div>{row.original.uom?.label || row.original.uom?.value || ""}</div>;
          // },
        },
        {
          Header: "Unit Price",
      ...
      commonColumns?.push({
        ...
        Cell: cellProps => (
          <div className="d-flex gap-3">
            {[0].includes(cellProps.row.original?.request_status) && poPermission && poPermission?.can_edit && activeTab === 2 && (
              <Link
                to="#"
            ...
            {[0].includes(cellProps.row.original?.request_status) && poPermission && poPermission?.can_delete && activeTab === 2 && (
              <Link
                to="#"
            ...
            {[0].includes(cellProps.row.original?.request_status) && poPermission && poPermission?.can_approved && activeTab !== 5 && (
              <Link
                to="#"
                onClick={() => onClickApproveStatus(cellProps.row.original)}
                className="text-success"
              >
                <i className="mdi mdi-sticker-check-outline font-size-18" id={`approvetooltip_${cellProps.row.index}`} />
                <UncontrolledTooltip placement="top" target={`approvetooltip_${cellProps.row.index}`}>
                  Approve/Reject
                </UncontrolledTooltip>
              </Link>
            )}
                  ...
                  <Row>
                    <Col md={12} className="mb-3">
                      ...
                      <Input
                        type="Number"
                        name="so_line_item"
                        className={`form-control ${formErrors.so_line_item ? "is-invalid" : ""
                          }`}
                        id="formrow-state-Input"
                        placeholder="Please Enter Line Item Number"
                        value={formData?.so_line_item}
                        onChange={e => {
                          setFormData(prevData => ({
                            ...prevData,
                            so_line_item: e.target.value,
                          }));
                          setFormErrors(prevErrors => ({
                            ...prevErrors,
                            so_line_item: "",
                    ...
                    <Col md={12} className="mb-3">
                      <div className="mb-3">
                        ...
                        <Input
                          type="number"
                          name="po_quantity"
                          className={`form-control ${formErrors.po_quantity ? "is-invalid" : ""
                            }`}
                          id="formrow-state-Input"
                    ...
                    <Col md={12} className="mb-3">
                      <div className="mb-3">
                        ...
                        <Input
                          type="number"
                          name="net_price"
                          className={`form-control ${formErrors.net_price ? "is-invalid" : ""
                            }`}
                          id="formrow-state-Input"
                    ...
                    <Col md={12} className="mb-3">
                      <div className="mb-3">
                        ...
                        <Input
                          type="number"
                          name="net_value"
                          className={`form-control ${formErrors.net_value ? "is-invalid" : ""
                            }`}
                          id="formrow-state-Input"
                          placeholder="Please Enter Net Price"
              ...
              <Col lg="12">
                <div className="custom-tabs-wrapper">
                  <ul className="custom-tab-nav">
                    {[
                      { id: 2, label: "Open SO" },
                      { id: 3, label: "Approved SO" },
                      { id: 4, label: "Rejected SO" },
                      { id: 5, label: "Closed SO" },
                    ].map((tab, index) => (
