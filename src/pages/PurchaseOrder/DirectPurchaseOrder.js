...
const DirectPurchaseOrder = () => {
  ...
  const dropdownList = async () => {
    ...
    // console.log("Clearing selected PR values");
    setSelectedPRValues([]);
  ...
  const handleAddRowNested = () => {
    const newLineNo =
      PRLineItemList.length > 0 ? parseInt(PRLineItemList[PRLineItemList.length - 1].polineNo) + parseInt(10) : 10;
    setPRLineItemList([
      ...PRLineItemList,
      {
        polineNo: newLineNo,
  ...
  const handleRemoveRowNested = idx => {
    ...
    const removedItem = newLineItems.splice(idx, 1)[0];
    setPRLineItemList(newLineItems);

    const totalAmount = newLineItems.reduce((sum, item) => {
      return sum + (item.total_net_value === "" ? 0 : Number(item.total_net_value));
    }, 0);
  ...
  const handleInputChange = (index, fieldName, value) => {
    ...
    const totalAmount = PRLineItemList.reduce((sum, item) => {
      return (
    ...
    const totalTaxAmount = PRLineItemList.reduce((sum, item) => {
      return sum + (item.tax_amount == "" ? 0 : Number(item.tax_amount));
    }, 0);
    ...
    PRLineItemList.forEach((item, index) => {
      Object.keys(item).forEach(fieldName => {
        if (
          ...
          `product_code-${index}` === `${fieldName}-${index}` ||
          // `product_description-${index}` === `${fieldName}-${index}` ||
          `vendor_prod_description-${index}` === `${fieldName}-${index}` ||
          `warehouse-${index}` === `${fieldName}-${index}` ||
          `location-${index}` === `${fieldName}-${index}` ||
          `delivery_date-${index}` === `${fieldName}-${index}`
        ) {
  ...
  const handleSave = () => {
    ...
    const Data = {
      formData,
      prFilteredItems: PRLineItemList,
      prPo,
    };
    dispatch({
      type: ADD_PO_REQUEST,
                        ...
                        <Col lg="12">
                          <div>
                            ...
                            <Table style={{ width: "100%" }}>
                              <tbody>
                                {PRLineItemList.map((item, idx) => (
                                  <tr
                                    style={{
                                      borderBottom:
                                        idx < PRLineItemList.length - 1
                                          ? "2px #000"
                                          : "none",
                                    }}
                                    id={`addr${idx}`}
                                          ...
                                          <Row data-repeater-item>
                                            ...
                                            <Col lg="2" className="mb-1">
                                              ...
                                              <Select
                                                ...
                                                onChange={async selectProducts => {
                                                  ...
                                                  const netValue = Number(item?.total_net_value || 0);

                                                  const taxAmount = (netValue * gstRate) / 100;
                                                  ...
                                                  if (getProductsData?.uom) {
                                                    handleInputChange(idx, "uom", getProductsData.uom);
                                                  }
                                                  handleInputChange(idx, "product_description", getProductsData?.product_description);
                                                  handleInputChange(idx, "gst_classification_id", getProductsData?.gst_classification_id);
                                                }}
                                              />
                                            </Col>
                                            ...
                                            <Col lg="1" className="mb-1">
                                              ...
                                              <Input
                                                ...
                                                onChange={e => {
                                                  ...
                                                  const gstRate = Number(item?.tax_per || 0);
                                                  if (
                                                    value === "" ||
                                            ...
                                            {/* <Col lg="2" className="mb-1">
                                              ...
                                              <Input
                                                ...
                                                className={`form-control-sm ${errors[`product_description-${idx}`]
                                                  ? "border-danger"
                                                  : ""
                                            ...
                                            <Col lg="2" className="mb-1">
                                              ...
                                              <Input
                                                type="textarea"
                                                value={item.vendor_prod_description || ""}
                                                onChange={e =>
                                                  handleInputChange(
                                                    idx,
                                                    "vendor_prod_description",
                                                ...
                                                id={`vendor_prod_description-${idx}`}
                                                className={`form-control-sm ${errors[`vendor_prod_description-${idx}`]
                                                  ? "border-danger"
                                                  : ""
                                                  }`} // Add 'border-danger' class for error
                                                style={{
                                                  borderColor: errors[
                                                    `vendor_prod_description-${idx}`
                                                  ]
                                                    ? "#f46a6a"
                                                    : undefined,
                                                      ...
                                                      onChange={selectedDates => {
                                                        ...
                                                        if (moment(selectedDates[0]).isBefore(docDate)) {
                                                          ...
                                                          setFormErrors(prevErrors => ({
                                                            ...prevErrors,
                                                            [`delivery_date${idx}`]: "Delivery Date cannot be before Document Date.",
                                                          }));
                                                        } else {
                                                          // Clear the error and update the state
                                                          setFormErrors(prevErrors => ({
                                                            ...prevErrors,
                                                            [`delivery_date${idx}`]: undefined,
                                                          }));
